...
public class HighlightConfigParam extends org.json.simple.JSONObject {
   ...
   */
  public HighlightConfigParam(Boolean showInfoOpt, Boolean showRulersOpt, Boolean showExtensionLinesOpt, Boolean showLayoutEditorOpt, Boolean displayAsMaterialOpt, org.chromium.sdk.internal.wip.protocol.output.dom.RGBAParam contentColorOpt, org.chromium.sdk.internal.wip.protocol.output.dom.RGBAParam paddingColorOpt, org.chromium.sdk.internal.wip.protocol.output.dom.RGBAParam borderColorOpt, org.chromium.sdk.internal.wip.protocol.output.dom.RGBAParam marginColorOpt, org.chromium.sdk.internal.wip.protocol.output.dom.RGBAParam eventTargetColorOpt, org.chromium.sdk.internal.wip.protocol.output.dom.RGBAParam shapeColorOpt, org.chromium.sdk.internal.wip.protocol.output.dom.RGBAParam shapeMarginColorOpt) {
    if (showInfoOpt != null) {
    ...
    if (showLayoutEditorOpt != null) {
      this.put("showLayoutEditor", showLayoutEditorOpt);
    }
